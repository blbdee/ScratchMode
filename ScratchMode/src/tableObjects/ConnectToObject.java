...
public class ConnectToObject {
	
    public static Connection con = null;

    public ConnectToObject(String driver, String url, String login, String pass) {
    ...
    public Vector<Vector<Object>> getNomen(String query) {
        ...
        try {
            ...
            for (int i = 1; i <= cols; i++) {
                TableModel.columnNames.addElement( rsmd.getColumnName(i) );
            }
            while (rs.next()) {
