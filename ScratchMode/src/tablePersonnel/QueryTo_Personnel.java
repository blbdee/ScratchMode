...
public class QueryTo_Personnel {
	
    public static Connection con = null;

    public QueryTo_Personnel(String driver, String url, String login, String pass) {
    ...
    public Vector<Vector<Object>> getNomen(String query) {
        ...
        try {
            ...
            for (int i = 1; i <= cols; i++) {
                TablePersonnel.columnNames.addElement( rsmd.getColumnName(i) );                
            }
            while (rs.next()) {
