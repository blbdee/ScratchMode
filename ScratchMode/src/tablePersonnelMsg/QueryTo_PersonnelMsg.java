...
public class QueryTo_PersonnelMsg {
	
    public static Connection con = null;

    public QueryTo_PersonnelMsg(String driver, String url, String login, String pass) {
    ...
    public Vector<Vector<Object>> getNomen(String query) {
        ...
        try {
            ...
            for (int i = 1; i <= cols; i++) {
                TablePersonnelMsg.columnNames.addElement( rsmd.getColumnName(i) );                
            }
            while (rs.next()) {
